...
public class RidesAndFaresExercise {
    ...
    public static class EnrichmentFunction extends RichCoFlatMapFunction<TaxiRide, TaxiFare, RideAndFare> {
        ...
        private ValueState<TaxiRide> rideState;  // Указание типа для ValueState
        private ValueState<TaxiFare> fareState;  // Указание типа для ValueState

        @Override
        public void open(Configuration config) {
            // Использование ValueStateDescriptor с явным указанием типа
