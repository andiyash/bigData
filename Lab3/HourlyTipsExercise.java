...
public class HourlyTipsExercise {
    ...
    public JobExecutionResult execute() throws Exception {
        ...
        // установка среды выполнения потоковых вычислений
        StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();

        // запуск генератора данных и организация выставления водяных знаков
        ...
        // вычисление часовых чаевых для каждого водителя
        ...
        // поиск водителя с наибольшей суммой чаевых за каждый час
        ...
        // выполнение конвейера трансформации
